...
public class RedisUtil<T> {
    ...
    public void save(T t,String id, String hash){
        hashOperations.put(hash,id,t);
    }

    public void update(T t,String id, String hash){
        hashOperations.put(hash,id,t);
    }

    public void delete(String id, String hash){
